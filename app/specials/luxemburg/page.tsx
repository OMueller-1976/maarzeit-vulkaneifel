...
export const metadata: Metadata = {
  title: "Ausflug nach Luxemburg ab Kirchweiler – UNESCO-Altstadt & Kultur | MaarZeit",
  description:
    "Luxemburg liegt ca. 95 km von der Ferienwohnung in der Vulkaneifel entfernt. UNESCO-Altstadt, Casemates, Grund und Shopping – Luxemburg als Tagesausflug aus der Eifel.",
  keywords: [
    "Luxemburg Ausflug Eifel",
    "Luxemburg Stadt Tagesausflug",
    "UNESCO Altstadt Luxemburg",
    "Luxemburg Ferienwohnung Eifel",
    "Ausflug Luxemburg Vulkaneifel",
    "Luxemburg Shopping Eifel",
  ],
};
